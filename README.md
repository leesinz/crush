...
运行后会默认在data目录下创建日志文件，以exploit-db为例：

![image-20240306143012500](assets/image-20240306143012500.png)

msf和vulhub是通过git pull的形式来匹配是否更新漏洞poc，因此会有两个日志文件：update_history.log和update_info.log.

update_history:

![image-20240306143132278](assets/image-20240306143132278.png)

update_info:

![image-20240306143226828](assets/image-20240306143226828.png)
